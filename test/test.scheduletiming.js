...
var tests = [
  ...
  ['2016-03-13 01:59', [1, -1]], //actually 2016-03-13 01:59
  ...
  ['2016-11-06 00:00', [180, 118]], //actually 2016-11-06 00:00, offset still -8
  ['2016-11-06 01:59', [61, -1]], //actually 2016-11-06 01:59, first occurence, offset still -8
  ...
  ['2016-11-06 02:01', [-1, -63]] //actually 2016-11-06 02:01, offset changed to -5
];
...
function testSchedules (test) {
  ...
  schs.forEach(function (sch, ind) {
    ...
    trigger = schedule.estimateTrigger()/60/1000; 
    if (trigger !== exp[ind]) {
